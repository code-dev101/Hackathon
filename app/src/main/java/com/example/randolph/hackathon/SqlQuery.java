...
public class SqlQuery {
        ...
        try {
            if(activity != null){
                ...
                db.execSQL("CREATE TABLE IF NOT EXISTS" + TABLE_NAME + " ("+_sUid+" INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        ...
                        " "+ _sLname+ " VARCHAR(30), "+ _sEmail +" VARCHAR(30), "+_sCardNm+" VARCHAR(50), "+ _sPin+ " INTEGER(5)  );");
    ...
    public void createAccount(String sUname, String sUpass, String sFname, String sMname, String sLname, String sEmail, String sCarnNm,  String sPin){
        try{
            //("+_sUname+", "+_sUpass+" , "+_sFname+", "+_sMname+", "+_sLname+" , "+_sEmail+" ," +"+_sCardNm+", "+_sPin+")
            db.execSQL("INSERT INTO  "+ TABLE_NAME+"  VALUES (1, '"+sUname+"','"+sUpass+"','"+sFname+"', '"+sMname+"', '"+sLname+"', '"+sEmail+"' , '"+sCarnNm+"', "+sPin+");");
